...
- Historical docs used to say "Emergency 400ms dwell" — **current code says `emergencyButton` defaults to 2000ms and `medicalUrgent` defaults to 900ms** in `dwellTimeConfig.ts`. Use the code/config value, not old prose.
