...
export const darkColors = {
  ...
  navigation: {
    ...
    containerDivider: 'rgba(42, 61, 82, 0.72)',
...
export const mixColors = {
  home: {
    ...
    mutedText: '#3F3327',
    brand: '#B49362',
    cardBorder: 'rgba(91, 74, 51, 0.30)',
    cardShadow: '0 8px 22px rgba(0,0,0,0.30)',
    dockSeparator: 'rgba(180, 157, 112, 0.24)',
    quickPhrasesBg: '#352C21',
    quickPhrasesBorder: '#8B6F49',
    quickPhrasesText: '#F0E2C4',
    quickPhrasesShadow: '0 0 0 1px rgba(139,111,73,0.22), 0 8px 22px rgba(0,0,0,0.30)',
    emergencyBg: '#8A463D',
    emergencyHover: '#7A3A34',
    emergencySoft: '#CFA094',
    placeholderBg: 'rgba(196, 178, 142, 0.08)',
    placeholderBorder: 'rgba(196, 178, 142, 0.22)',
    dividerBackground: 'linear-gradient(180deg, transparent 0%, rgba(180, 157, 112, 0.24) 50%, transparent 100%)',
    tileSurfaces: {
      kb: '#C4B28E',
      ph: '#C4B28E',
      ac: '#C4B28E',
